...
public interface BookingService {
    ...
    List<BookingResponse> getUserBookings(Long userId, String state, Integer from, Integer size);

    List<BookingResponse> getOwnerBookings(Long userId, String state, Integer from, Integer size);
}
